...
public interface MealFoodService {
	...
	void update(MealFoodUpdateRequest updateRequest, Long id)
			throws ValidationException, MealFoodNotFoundException, MeasureNotFoundException, ConvertTypeNotRecognizedException;
