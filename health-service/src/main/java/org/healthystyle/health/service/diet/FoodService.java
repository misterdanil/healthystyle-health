...
public interface FoodService {
	...
	Food save(FoodSaveRequest saveRequest) throws ValidationException, FoodExistException, NutritionValueNotFoundException, FoodValueExistException, FoodNotFoundException, ConvertTypeMismatchException;

	void update(FoodUpdateRequest updateRequest, Long foodId) throws ValidationException, FoodNotFoundException, FoodExistException;
